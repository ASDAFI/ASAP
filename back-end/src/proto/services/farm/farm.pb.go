...
var file_services_farm_proto_rawDesc = []byte{
	...
	0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1b,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f,
	0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xac, 0x02, 0x0a, 0x04,
	...
	0x22, 0x06, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x3a, 0x01, 0x2a, 0x12, 0x52, 0x0a, 0x06, 0x4c,
	...
	0x79, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x25, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63,
	0x65, 0x73, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x73, 0x2e, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x2f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0x42, 0x0f, 0x5a, 0x0d, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x66, 0x61, 0x72, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var file_services_farm_proto_goTypes = []interface{}{
	(*user.LoginRequest)(nil),            // 0: messages.user.LoginRequest
	(*user.LogoutRequest)(nil),           // 1: messages.user.LogoutRequest
	(*devices.CreateDeviceRequest)(nil),  // 2: messages.devices.CreateDeviceRequest
	(*user.LoginResponse)(nil),           // 3: messages.user.LoginResponse
	(*emptypb.Empty)(nil),                // 4: google.protobuf.Empty
	(*devices.CreateDeviceResponse)(nil), // 5: messages.devices.CreateDeviceResponse
}
var file_services_farm_proto_depIdxs = []int32{
	0, // 0: service.farm.Farm.Login:input_type -> messages.user.LoginRequest
	1, // 1: service.farm.Farm.Logout:input_type -> messages.user.LogoutRequest
	2, // 2: service.farm.Farm.CreateDevice:input_type -> messages.devices.CreateDeviceRequest
	3, // 3: service.farm.Farm.Login:output_type -> messages.user.LoginResponse
	4, // 4: service.farm.Farm.Logout:output_type -> google.protobuf.Empty
	5, // 5: service.farm.Farm.CreateDevice:output_type -> messages.devices.CreateDeviceResponse
...
type FarmClient interface {
	...
	Logout(ctx context.Context, in *user.LogoutRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *farmClient) Logout(ctx context.Context, in *user.LogoutRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type FarmServer interface {
	...
	Logout(context.Context, *user.LogoutRequest) (*emptypb.Empty, error)
...
func (*UnimplementedFarmServer) Logout(context.Context, *user.LogoutRequest) (*emptypb.Empty, error) {
